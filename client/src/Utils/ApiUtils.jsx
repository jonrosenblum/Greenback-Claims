...
export const getUserByReferralId = baseUrl + 'api/auth/refuser/';
export const initializeDB = baseUrl + 'initialize-db';
export const sendReferralEmail = baseUrl + 'send-referral-email';
export const sendEmail = baseUrl + 'send-email';
