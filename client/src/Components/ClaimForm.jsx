...
export default function ClaimForm({ onEmailSent }) {
            ...
            <div className='block [@media(min-width:500px)]:flex justify-between items-end mt-10'>
              <div className='block [@media(min-width:500px)]:flex items-end gap-5'>
                ...
                <div className='flex flex-col items-start'>
                  {url?<p className='text-green-700 font-medium'>PDF saved, Please proceed to next.</p>:<p>Please sign and save the PDF before moving forward</p>}
  ...
  return (
    ...
    <div className="bg-white text-black pl-3 pr-3 pb-3 h-auto sm:h-[700px] overflow-y-auto">
      <Toaster />
