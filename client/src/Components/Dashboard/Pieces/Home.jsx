                ...
                <div className="flex flex-wrap -mx-3">
                  <div className="max-w-full px-3 lg:w-1/2 lg:flex-none">
                    <div className="flex flex-col h-full">
                      <p className="pt-2 mb-1 font-semibold">Start earning money now :)</p>
                      <h5 className="font-bold">Hi {user.username}! Welcome to your Referral Dashboard</h5>
                      <p className="mb-12">This dashboard is specially designed for managing your referrals to claims. Share your referral link to anyone.</p>
